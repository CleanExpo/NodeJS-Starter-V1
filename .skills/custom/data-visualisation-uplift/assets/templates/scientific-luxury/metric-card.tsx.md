# Metric card — Scientific Luxury

Single KPI display with trend indicator, delta, and optional sparkline. OLED Black surface, spectral colour-coded trend, JetBrains Mono value, Framer Motion count-up animation.
...
function getTrendColour(direction: 'up' | 'down' | 'flat'): string {
  switch (direction) {
    case 'up':
      return SPECTRAL.positive;
    case 'down':
      return SPECTRAL.negative;
    case 'flat':
      return SPECTRAL.neutral;
  }
}
