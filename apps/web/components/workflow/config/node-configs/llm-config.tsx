...
const LLM_MODELS = [
  {
    ...
    provider: 'Anthropic',
    description: 'Most capable — extended thinking, Fast Mode',
  },
  {
    value: 'claude-sonnet-4-6',
    label: 'Claude Sonnet 4.6',
    provider: 'Anthropic',
    description: 'Balanced — thinking, web search, code execution',
  },
  {
    value: 'claude-haiku-4-5-20251001',
    label: 'Claude Haiku 4.5',
    provider: 'Anthropic',
    description: 'Fastest — high throughput tasks',
  },
  { value: 'gpt-4-turbo', label: 'GPT-4 Turbo', provider: 'OpenAI', description: '' },
  { value: 'gpt-4o', label: 'GPT-4o', provider: 'OpenAI', description: '' },
  { value: 'llama3.1:8b', label: 'Llama 3.1 8B', provider: 'Ollama', description: '' },
  { value: 'llama3.1:70b', label: 'Llama 3.1 70B', provider: 'Ollama', description: '' },
];
