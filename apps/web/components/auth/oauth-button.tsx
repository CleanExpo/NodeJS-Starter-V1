 ...
 *
 * A reusable button for OAuth authentication with various providers.
 * Handles the OAuth flow initiation and loading states.
 */
export function OAuthButton({ provider, redirectTo }: OAuthButtonProps) {
